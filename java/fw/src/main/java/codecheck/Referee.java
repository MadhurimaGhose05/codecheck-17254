/*
    ...
    Description: Referee class, become the referee of the game.
    Because two players are needed, manage with Thread
*/
package codecheck;
...
public class Referee {
    ...
    synchronized public static void showJudgementResult(String word, String playerStr) {
        if(playerStr != null && !isGameOver) {
            / / Ignore the words you sent before the two players get together.
